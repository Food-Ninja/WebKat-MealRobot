...
# [Tool](https://github.com/Food-Ninja/WikiHow-Instruction-Extraction)
...
<div>
    <img alt="Table summarizing the 6 action groups and their parameters" src='{{"img/picking_up_actions.jpg" | absURL }}'
         width="800">

</div>


  <html><img alt="Table summarizing the 6 action groups and their parameters" src='{{"img/picking_up_actions.jpg" | absURL }}'
         width="800"></html>
<p align="center">
  <img src={"src":"img/picking_up_actions.jpg"} width="800" alt="Summarising the structure of a WikiHow article"/><br>
</p>
![picking_up_actions.jpg](..%2F..%2F..%2Fstatic%2Fimg%2Fpicking_up_actions.jpg)
## Action Verb Frames
